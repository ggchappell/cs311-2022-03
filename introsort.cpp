...
{
    const size_t SMALL_SIZE = 42;  // Max size of "small" sublist
    ...
    while (true)  // For tail-recursion elimination
    {
        ...
        // depth limit, we do not need to do this.
        introsort_recurse(first, pivotiter, depth-1);
