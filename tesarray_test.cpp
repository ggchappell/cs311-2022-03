...
// Requires doctest.h, tesarray.h

// Includes for code to be tested
#include "tesarray.h"        // For class template TESArray
#include "tesarray.h"        // Double-inclusion check, for testing only
...
TEST_CASE( "TESArray member types" )
{
    SUBCASE( "Member type value_type" )
    {
        {
        TESArray<int>::value_type x1;
        [[maybe_unused]] int & r(x1);
        INFO( "TESArray<int>::value_type must be int" );
        REQUIRE( TypeCheck<int>::check(x1) );
        }

        {
        TESArray<string>::value_type x2;
        [[maybe_unused]] string & r(x2);
        INFO( "TESArray<string>::value_type must be string" );
    ...
    {
        {
        TESArray<int>::size_type x1;
        [[maybe_unused]] size_t & r(x1);
        INFO( "TESArray<int>::size_type must be size_t" );
        REQUIRE( TypeCheck<size_t>::check(x1) );
        }

        {
        TESArray<string>::size_type x2;
        [[maybe_unused]] size_t & r(x2);
        INFO( "TESArray<string>::size_type must be size_t" );
    ...
    {
        {
        TESArray<int>::iterator x1;
        [[maybe_unused]] int * & r(x1);
        INFO( "TESArray<int>::iterator must be (int *)" );
        REQUIRE( TypeCheck<int *>::check(x1) );
        }

        {
        TESArray<string>::iterator x2;
        [[maybe_unused]] string * & r(x2);
        INFO( "TESArray<string>::iterator must be (string *)" );
        REQUIRE( TypeCheck<string *>::check(x2) );
        }
    }
    ...
    {
        {
        TESArray<int>::const_iterator x1;
        [[maybe_unused]] const int * & r(x1);
        INFO( "TESArray<int>::const_iterator must be (const int *)" );
        REQUIRE( TypeCheck<const int *>::check(x1) );
        }

        {
        TESArray<string>::const_iterator x2;
        [[maybe_unused]] const string * & r(x2);
        INFO( "TESArray<string>::const_iterator must be (const int *)" );
...
TEST_CASE( "TESArray function return types" )
{
    SUBCASE( "Member function copy= - return type" )
    {
        {
        const TESArray<int> cti;
        TESArray<int> ti;
        [[maybe_unused]] TESArray<int> & r(ti = cti);
        INFO( "TESArray<int> copy= returns TESArray<int> by ref" );
        REQUIRE( TypeCheck<TESArray<int>>::check(ti = cti) );
        }

        {
        const TESArray<string> cts;
        TESArray<string> ts;
        [[maybe_unused]] TESArray<string> & r(ts = cts);
        INFO( "TESArray<string> copy= returns TESArray<string> by ref" );
        REQUIRE( TypeCheck<TESArray<string>>::check(ts = cts) );
        }
    }
    ...
    SUBCASE( "Member function move= - return type" )
    {
        ...
        TESArray<int> ti2;
        TESArray<int> ti3;
        [[maybe_unused]] TESArray<int> & r(ti1 = move(ti2));
        INFO( "TESArray<int> move= returns TESArray<int> by ref" );
        REQUIRE( TypeCheck<TESArray<int>>::check(ti2 = move(ti3)) );
        }
        ...
        TESArray<string> ts2;
        TESArray<string> ts3;
        [[maybe_unused]] TESArray<string> & r(ts1 = move(ts2));
        INFO( "TESArray<string> move= returns TESArray<string> by ref" );
        REQUIRE( TypeCheck<TESArray<string>>::check(ts2 = move(ts3)) );
        }
    }
    ...
    {
        {
        const TESArray<int> cti(10);
        [[maybe_unused]] size_t && r(cti.size());
        INFO( "TESArray<int> size returns size_t by value" );
        REQUIRE( TypeCheck<size_t>::check(cti.size()) );
        }

        {
        const TESArray<string> cts(10);
        [[maybe_unused]] size_t && r(cts.size());
        INFO( "TESArray<string> size returns size_t by value" );
    ...
    SUBCASE( "Member function empty - return type" )
    {
        ...
        INFO( "TESArray<int> empty returns bool by value" );
        ...
        INFO( "TESArray<string> empty returns bool by value" );
    ...
    SUBCASE( "Member function bracket op - return type" )
    {
        ...
        INFO( "TESArray<int> bracket op returns int by ref" );
        REQUIRE( TypeCheck<int>::check(ti[0]) );
        }

        {
        TESArray<string> ts(10);
        [[maybe_unused]] string & r(ts[0]);
        INFO( "TESArray<string> bracket op returns string by ref" );
        ...
        INFO( "const TESArray<int> bracket op returns const int by ref" );
        ...
        INFO( "const TESArray<string> bracket op returns const string by ref" );
    ...
    SUBCASE( "Member function begin - return type" )
    {
        ...
        INFO( "TESArray<int> begin returns (int *) by value" );
        ...
        INFO( "TESArray<string> begin returns (string *) by value" );
        ...
        INFO( "const TESArray<int> begin returns (const int *) by value" );
        ...
        INFO( "const TESArray<string> begin returns (const string *) by value" );
    ...
    SUBCASE( "Member function end - return type" )
    {
        ...
        INFO( "TESArray<int> end returns (int *) by value" );
        ...
        INFO( "TESArray<string> end returns (string *) by value" );
        ...
        INFO( "const TESArray<int> end returns (const int *) by value" );
        ...
        INFO( "const TESArray<string> end returns (const string *) by value" );
    ...
    SUBCASE( "Member function insert - return type" )
    {
        ...
        INFO( "TESArray<int> insert returns (int *) by value" );
        ...
        INFO( "TESArray<string> insert returns (string *) by value" );
    ...
    SUBCASE( "Member function erase - return type" )
    {
        ...
        INFO( "TESArray<int> erase returns (int *) by value" );
        ...
        INFO( "TESArray<string> erase returns (string *) by value" );
...
TEST_CASE( "TESArray noexcept" )
{
    TESArray<Counter> tc1;
    TESArray<Counter> tc2;

    SUBCASE( "noexcept - move ctor" )
    {
        INFO( "Move ctor must be noexcept" );
        REQUIRE( noexcept(TESArray<Counter>(move(tc1))) );
    }
    ...
    SUBCASE( "NOT noexcept - copy ctor" )
    {
        ...
        REQUIRE_FALSE( noexcept(TESArray<Counter>(tc1)) );
    }

    SUBCASE( "NOT noexcept - ctor from size" )
    {
        INFO( "Ctor from size must NOT be noexcept" );
        REQUIRE_FALSE( noexcept(TESArray<Counter>(100)) );
    }
...
TEST_CASE( "TESArray default ctor, size, empty" )
{
    SUBCASE( "Default ctor" )
    {
        const TESArray<int> cti;
        {
        INFO( "Default constructed TESArray has size 0" );
        REQUIRE( cti.size() == size_t(0) );
        }
        {
        INFO( "Default constructed TESArray is empty" );
        REQUIRE( cti.empty() );
        }
        {
        INFO( "Default constructed TESArray: begin == end" );
...
TEST_CASE( "TESArray ctor from size, size, empty, begin, end" )
{
    SUBCASE( "Ctor from size - size 0" )
    {
        const size_t SIZE = size_t(0);
        const TESArray<int> cti(SIZE);
        {
        INFO( "TESArray constructed with size " << SIZE << ": size" );
        REQUIRE( cti.size() == SIZE );
        }
        {
        INFO( "TESArray constructed with size " << SIZE << " is empty" );
        REQUIRE( cti.empty() );
        }
        {
        INFO( "TESArray constructed with size " << SIZE << ": begin == end" );
        REQUIRE( cti.begin() == cti.end() );
        }
    }
    ...
    SUBCASE( "Ctor from size - small size" )
    {
        ...
        {
        INFO( "TESArray constructed with size " << SIZE << " is not empty" );
        REQUIRE_FALSE( cti.empty() );
        }
        {
        INFO( "TESArray constructed with size " << SIZE << ": begin" );
        REQUIRE( cti.begin() == &cti[0] );
        }
        {
        INFO( "TESArray constructed with size " << SIZE << ": end" );
...
TEST_CASE( "TESArray bracket operator" )
{
    SUBCASE( "Bracket op" )
    {
        const size_t SIZE = size_t(10);
        TESArray<int> ti(SIZE);
...
TEST_CASE( "TESArray copy ctor" )
{
    ...
    {
        const size_t SIZE = size_t(10);
        TESArray<int> * tip = new TESArray<int>(SIZE);
        for (size_t i = 0; i < SIZE; ++i)
        {
...
TEST_CASE( "TESArray copy assignment operator" )
{
...
TEST_CASE( "TESArray move assignment operator" )
{
...
TEST_CASE( "TESArray insert" )
{
    const size_t SIZE = size_t(10);
    TESArray<int> ti_original(SIZE);
    for (size_t i = 0; i < SIZE; ++i)
    {
...
TEST_CASE( "TESArray push_back & pop_back" )
{
...
TEST_CASE( "TESArray swap" )
{
    SUBCASE( "swap" )
    {
        const size_t SIZE1 = size_t(10);
        const size_t SIZE2 = size_t(1000);
        TESArray<int> ti1(SIZE1);
        for (size_t i = 0; i < SIZE1; ++i)
        {
            ti1[i] = int(i)*int(i);
        }
        TESArray<int> ti2(SIZE2);
        for (size_t i = 0; i < SIZE2; ++i)
        {
            ti2[i] = 100-int(i);
        }
...
TEST_CASE( "TESArray ctor/dctor count" )
{
    SUBCASE( "Ctor/dctor calls on construction by size, destruction" )
    {
        ...
        size_t objectcount;  // Ctor calls - dctor calls
        {
            ...
            const TESArray<Counter> tc(SIZE);
    ...
    SUBCASE( "Ctor/dctor calls on move construction, destruction" )
    {
        ...
        {
            TESArray<Counter> tc;
            const TESArray<Counter> tc2(move(tc));
...
TEST_CASE( "TESArray exceptions" )
{
    ...
    SUBCASE( "Exceptions - copy ctor" )
    {
        Counter::reset(true);
        {
            const TESArray<Counter> tc(10);

            try
            {
                TESArray<Counter> tc2(tc);
    ...
    SUBCASE( "Exceptions - swap" )
    {
        Counter::reset(true);
        {
            TESArray<Counter> tc1(10);
            TESArray<Counter> tc2(1000);
